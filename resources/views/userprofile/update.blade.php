  ...
  <div class="row">
    <div class="col-lg-9 col-md-12 mb-3">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('user_profile_handle_update', $user->id) }}">
          @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <div class="input-group mb-2 mr-sm-2">
                  <input type="text" class="form-control" id="name" value="{{ title_case($user->statususer->description) }}" readonly>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <div class="input-group mb-2 mr-sm-2">
                  <input type="text" class="form-control" id="name" value="{{ title_case($user->typeuser->description) }}" readonly>
                    <div class="input-group-append">
                      <div class="input-group-text badge-success"><i class="fa fa-lock"></i></div>
                    </div>
                </div>
